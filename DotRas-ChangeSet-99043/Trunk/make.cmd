...
"%FXFOLDER%\MSBuild.exe" .\build.proj /p:CertificateKeyFile="%CERTFILE%" /p:StrongNameKeyFile="%KEYFILE%" /p:SkipTests=%SKIPTEST% /p:SkipDocumentation=%SKIPDOCS% /p:SkipPackage=%SKIPPACK% /fl /v:diag
