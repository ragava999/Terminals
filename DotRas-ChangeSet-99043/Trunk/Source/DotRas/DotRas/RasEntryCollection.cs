...
namespace DotRas
{
    ...
    public sealed class RasEntryCollection : RasOwnedCollection<RasPhoneBook, RasEntry>
    {
        ...
        /// </summary>
        /// <param name="owner">Required. The <see cref="DotRas.RasPhoneBook"/> that owns the collection.</param>
        ...
        /// </summary>
        /// <param name="item">Required. An <see cref="DotRas.RasEntry"/> whose key to change.</param>
        ...
        private class RasEntryItemCollection : KeyedCollection<string, RasEntry>
        {
            ...
            /// </summary>
            /// <param name="item">Required. An <see cref="DotRas.RasEntry"/> from which to extract the key.</param>
