...
namespace DotRas.UnitTests
{
    ...
    public class RasConnectionTest : UnitTest
    {
        ...
        /// <summary>
        /// Tests the GetActiveConnectionByHandle method to ensure an exception is thrown when the handle is a null reference.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        [ExpectedException(typeof(ArgumentNullException))]
        public void GetActiveConnectionByHandleWithNullHandleTest()
        {
            RasConnection.GetActiveConnectionByHandle(null);
        }
        ...
        public void GetActiveConnectionByHandleTest()
        {
            ...
            RasConnection expected = new RasConnection()
            {
                Handle = handle
            };

            ReadOnlyCollection<RasConnection> connections = new ReadOnlyCollection<RasConnection>(
                new RasConnection[] { expected });

            Mock<IRasHelper> mock = new Mock<IRasHelper>();
            RasHelper.Instance = mock.Object;

            mock.Setup(o => o.GetActiveConnections()).Returns(connections);
        ...
        /// <summary>
        /// Tests the GetActiveConnectionByHandle method to ensure a null reference is returned when an incorrect handle is used.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void GetActiveConnectionByHandleNotFoundTest()
        {
            ...
            RasConnection expected = null;

            ReadOnlyCollection<RasConnection> connections = new ReadOnlyCollection<RasConnection>(
                new RasConnection[] { new RasConnection() { Handle = new RasHandle(new IntPtr(2), false) } });
        ...
        /// <summary>
        /// Tests the GetActiveConnectionById method to ensure a null reference is returned when the connection cannot be found.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void GetActiveConnectionByIdNotFoundTest()
        {
            RasConnection expected = null;
            ...
            RasConnection actual = RasConnection.GetActiveConnectionById(Guid.Empty);

            Assert.AreEqual(expected, actual);
        }

        /// <summary>
        /// Tests the GetActiveConnectionById method to ensure a connection is returned when the entry is found in the active connections.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        ...
        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure an ArgumentException is thrown when the entryName argument is a null reference.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        [ExpectedException(typeof(ArgumentException))]
        public void GetActiveConnectionByNameEntryNameNullTest()
        {
            RasConnection.GetActiveConnectionByName(null, "C:\\Test.pbk");
        }

        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure an ArgumentException is thrown when the entryName argument is an empty string.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        [ExpectedException(typeof(ArgumentException))]
        public void GetActiveConnectionByNameEntryNameEmptyTest()
        {
            RasConnection.GetActiveConnectionByName(string.Empty, "C:\\Test.pbk");
        }

        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure an ArgumentException is thrown when the phoneBookPath argument is a null reference.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        [ExpectedException(typeof(ArgumentException))]
        public void GetActiveConnectionByNamePhoneBookPathNullTest()
        {
            RasConnection.GetActiveConnectionByName("Test", null);
        }

        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure an ArgumentException is thrown when the phoneBookPath argument is empty.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        [ExpectedException(typeof(ArgumentException))]
        public void GetActiveConnectionByNamePhoneBookPathEmptyTest()
        {
            RasConnection.GetActiveConnectionByName("Test", string.Empty);
        }

        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure a connection is found when the expected entry is found in the active connections.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        ...
        /// <summary>
        /// Tests the GetActiveConnectionsByName method to ensure a connection is found when passing a relative path to the phonebook path argument.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void GetActiveConnectionByNameRelativePathTest()
        {
            string entryName = "Test";
            string phoneBookPath = ".\\Test.pbk";

            RasConnection expected = new RasConnection()
            {
                EntryName = entryName,
                PhoneBookPath = System.IO.Path.GetFullPath(phoneBookPath)
            };
        ...
        /// <summary>
        /// Tests the GetActiveConnectionByName method to ensure a null reference is returned if the connection cannot be found when the string casing does not match.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void GetActiveConnectionByNameCaseSensitiveTest()
        {
            string entryName = "Test";
            string phoneBookPath = "C:\\Test.pbk";
            ...
            RasConnection result = RasConnection.GetActiveConnectionByName("test", "c:\\test.pbk", StringComparison.CurrentCulture);
        ...
        public void HangUpTest()
        {
            ...
            mock.Setup(o => o.HangUp(It.IsAny<RasHandle>(), It.IsAny<int>())).Verifiable();
