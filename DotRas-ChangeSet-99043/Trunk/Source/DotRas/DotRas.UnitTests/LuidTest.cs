...
namespace DotRas.UnitTests
{
    ...
    public class LuidTest : UnitTest
    {
        ...
        /// <summary>
        /// Tests the constructor sets the internal lowPart field successfully.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void ConstructorLowPartTest()
        {
            int expected = 100;

            Luid_Accessor target = new Luid_Accessor(expected, 0);
            int actual = target.lowPart;

            Assert.AreEqual(expected, actual);
        }

        /// <summary>
        /// Tests the constructor sets the internal highPart field successfully.
        /// </summary>
        [TestMethod]
        [TestCategory(CategoryConstants.Unit)]
        public void ConstructorHighPartTest()
        {
            int expected = 100;

            Luid_Accessor target = new Luid_Accessor(0, expected);
            int actual = target.highPart;
