...
namespace Terminals.Configuration.Files.Main.Settings
{
    public static partial class Settings
    {
		...
		public static bool ProxyAutoDetect
        {
			get { return GetSection().ProxyAutoDetect; }

            set
            {
				GetSection().ProxyAutoDetect = value;
                SaveImmediatelyIfRequested();
            }
        }
        
		public static bool ProxyUseAuthCustom
        {
			get { return GetSection().ProxyUseAuthCustom; }

            set
            {
				GetSection().ProxyUseAuthCustom = value;
                SaveImmediatelyIfRequested();
            }
        }
        ...
        {
			get { return GetSection().ProxyUseAuth; }

            set
            {
				GetSection().ProxyUseAuth = value;
                SaveImmediatelyIfRequested();
            }
        }
        ...
        {
            get { return GetSection().ProxyUse; }

            set
            {
				GetSection().ProxyUse = value;
                SaveImmediatelyIfRequested();
            }
        }

		public static string ProxyXmlCredentialSetName
		{
			get { return GetSection().ProxyXmlCredentialSetName; }

			set
			{
				GetSection().ProxyXmlCredentialSetName = value;
				SaveImmediatelyIfRequested();
			}
		}
		...
		{
			get { return GetSection().ProxyPassword; }

			set
			{
				GetSection().ProxyPassword = value;
				SaveImmediatelyIfRequested();
			}
		}
		...
		{
			get { return GetSection().ProxyUserName; }

			set
			{
				GetSection().ProxyUserName = value;
				SaveImmediatelyIfRequested();
			}
		}
		...
		{
			get { return GetSection().ProxyDomainName; }

			set
			{
				GetSection().ProxyDomainName = value;
				SaveImmediatelyIfRequested();
			}
		}
