...
namespace Terminals.Configuration.Files.Main.Settings
{
    public static partial class Settings
    {
        ...
        {
            get { return GetSection().FavoritesButtons.ToList().ToArray(); }
        }
        ...
        public static void EditFavoriteButton(string oldFavoriteName, string newFavoriteName, bool showOnToolbar)
        {
        ...
        public static bool HasToolbarButton(string favoriteName)
        {
        ...
        private static void FireButtonsChangedEvent(List<string> oldButtons)
        {
            ...
            ConfigurationChangedEventArgs args = ConfigurationChangedEventArgs.CreateFromButtons(oldButtons, newButtons);
