...
namespace Terminals.Configuration.Files.Main
{
    public class TerminalsConfigurationSection : ConfigurationSection
    {
        ...
        {
            get { return PasswordFunctions.DecryptPassword(this.EncryptedAmazonAccessKey, "AmazonAccessKey"); }
            set { this.EncryptedAmazonAccessKey = PasswordFunctions.EncryptPassword(value); }
        }
        ...
        {
            get { return PasswordFunctions.DecryptPassword(this.EncryptedAmazonSecretKey, "AmazonSecretKey"); }
            set { this.EncryptedAmazonSecretKey = PasswordFunctions.EncryptPassword(value); }
        }
        ...
        {
            get { return (string)this["licenseKey"]; }
