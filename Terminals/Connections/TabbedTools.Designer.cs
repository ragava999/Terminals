...
using Terminals.Network.NTP;
using Terminals.Network.Ping;
using Terminals.Network.PortScanner;
using Terminals.Network.Servers;
using Terminals.Network.TraceRoute;
using Terminals.Network.WMI;
using Terminals.Network.WakeOnLAN;
using Terminals.Network.WhoIs;
...
namespace Terminals.Connections
{
    partial class TabbedTools
    {
        ...
        protected override void Dispose(bool disposing)
        {
			...
			if (ping1 != null && !ping1.IsDisposed)
            	ping1.Dispose();
			
			if (traceRoute1 != null && !traceRoute1.IsDisposed)
            	traceRoute1.Dispose();
			
			if (wmiControl1 != null && !wmiControl1.IsDisposed)
            	wmiControl1.Dispose();
			
			if (interfacesList1 != null && !interfacesList1.IsDisposed)
            	interfacesList1.Dispose();
			
			if (localConnections1 != null && !localConnections1.IsDisposed)
            	localConnections1.Dispose();
			
			if (dnsLookup1 != null && !dnsLookup1.IsDisposed)
            	dnsLookup1.Dispose();
			
			if (wakeOnLan1 != null && !wakeOnLan1.IsDisposed)
            	wakeOnLan1.Dispose();
			
			if (portScanner1 != null && !portScanner1.IsDisposed)
            	portScanner1.Dispose();
			
			if (services1 != null && !services1.IsDisposed)
            	services1.Dispose();
			
			if (networkShares1 != null && !networkShares1.IsDisposed)
            	networkShares1.Dispose();
			
			if (networkTime1 != null && !networkTime1.IsDisposed)
            	networkTime1.Dispose();
			
			if (terminalServerManager1 != null && !terminalServerManager1.IsDisposed)
            	terminalServerManager1.Dispose();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.traceRoute1 = new TraceRouteControl();
            this.tabPage3 = new System.Windows.Forms.TabPage();
            this.wmiControl1 = new Terminals.Network.WMI.WmiControl();
            ...
            this.dnsLookup1 = new DnsLookup();
            this.tabPage9 = new System.Windows.Forms.TabPage();
            this.networkShares1 = new Terminals.Network.WMI.NetworkShares();
            ...
            this.wakeOnLan1 = new WakeOnLan();
            this.tabPage13 = new System.Windows.Forms.TabPage();
            this.portScanner1 = new Terminals.Network.PortScanner.PortScanner();
        ...
        private TraceRouteControl traceRoute1;
        private System.Windows.Forms.TabPage tabPage3;
        private Terminals.Network.WMI.WmiControl wmiControl1;
        ...
        private DnsLookup dnsLookup1;
        private System.Windows.Forms.TabPage tabPage9;
        private Terminals.Network.WMI.NetworkShares networkShares1;
        ...
        private WakeOnLan wakeOnLan1;
        private System.Windows.Forms.TabPage tabPage13;
        private Terminals.Network.PortScanner.PortScanner portScanner1;
