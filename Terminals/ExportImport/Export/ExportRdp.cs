...
{
    public class ExportRdp : IExport
    {
        ...
        public static int ConvertFromSounds(RemoteSounds sounds)
        {
            switch (sounds)
            {
                case RemoteSounds.PlayOnServer:
                    return 1;
                case RemoteSounds.DontPlay:
                    return 2;
                default:
                    return 0;
            }
        ...
        public static int ConvertToColorBits(Colors colorBits)
        {
            switch (colorBits)
            {
                case Colors.Bits8:
