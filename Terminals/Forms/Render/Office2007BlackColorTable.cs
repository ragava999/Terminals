...
namespace Terminals.Forms.Render
{
    ...
    public class Office2007BlackColorTable : ProfessionalColorTable
    {
        ...
        private static readonly Color _contextMenuBack = Color.FromArgb(5, 5, 5);

        private static readonly Color _buttonPressedBegin = Color.FromArgb(50, 50, 50);
        private static readonly Color _buttonPressedMiddle = Color.FromArgb(25, 25, 25);
        private static readonly Color _buttonPressedEnd = Color.FromArgb(10, 10, 10);

        private static readonly Color _buttonSelectedBegin = Color.FromArgb(50, 50, 5);
        private static readonly Color _buttonSelectedMiddle = Color.FromArgb(25, 25, 25);
        private static readonly Color _buttonSelectedEnd = Color.FromArgb(10, 10, 10);

        private static readonly Color _menuItemSelectedBegin = Color.FromArgb(50, 50, 50);
        private static readonly Color _menuItemSelectedEnd = Color.FromArgb(10, 10, 10);

        private static readonly Color _checkBack = Color.FromArgb(10, 10, 10);

        private static readonly Color _gripDark = Color.FromArgb(10, 10, 10);
        private static readonly Color _gripLight = Color.FromArgb(50, 50, 50);

        private static readonly Color _imageMargin = Color.FromArgb(10, 10, 10);

        private static readonly Color _menuBorder = Color.FromArgb(10, 10, 10);
        private static readonly Color _menuToolBack = Color.FromArgb(0, 0, 0);

        private static readonly Color _overflowBegin = Color.FromArgb(50, 50, 50);
        private static readonly Color _overflowMiddle = Color.FromArgb(25, 25, 25);
        private static readonly Color _overflowEnd = Color.FromArgb(10, 10, 10);


        private static readonly Color _separatorDark = Color.FromArgb(10, 10, 10);
        private static readonly Color _separatorLight = Color.FromArgb(50, 50, 50);

        private static readonly Color _statusStripLight = Color.FromArgb(50, 50, 50);
        private static readonly Color _statusStripDark = Color.FromArgb(10, 10, 10);


        private static readonly Color _toolStripBorder = Color.FromArgb(10, 10, 10);
        private static readonly Color _toolStripContentEnd = Color.FromArgb(0, 0, 0);

        private static readonly Color _toolStripBegin = Color.FromArgb(50, 50, 50);
        private static readonly Color _toolStripMiddle = Color.FromArgb(25, 25, 25);
        private static readonly Color _toolStripEnd = Color.FromArgb(10, 10, 10);

        private static readonly Color _buttonBorder = Color.FromArgb(10, 10, 10);
