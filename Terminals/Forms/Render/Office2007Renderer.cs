...
namespace Terminals.Forms.Render
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static readonly GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3,
                                                                                                          _r4, _r5, _r6,
                                                                                                          _r7, _r8,
                                                                                                          Color.FromArgb
                                                                                                              (217, 203,
        ...
        private static readonly GradientItemColors _itemDisabledColors = new GradientItemColors(_c4, _c6,
                                                                                                Color.FromArgb(236, 236,
                                                                                                               236),
                                                                                                Color.FromArgb(230, 230,
                                                                                                               230), _c6,
                                                                                                Color.FromArgb(224, 224,
                                                                                                               224),
                                                                                                Color.FromArgb(200, 200,
                                                                                                               200),
                                                                                                Color.FromArgb(210, 210,
                                                                                                               210),
                                                                                                Color.FromArgb(212, 212,
                                                                                                               212),
                                                                                                Color.FromArgb(195, 195,
                                                                                                               195));

        private static readonly GradientItemColors _itemToolItemSelectedColors = new GradientItemColors(_r1, _r2, _r3,
                                                                                                        _r4, _r5, _r6,
                                                                                                        _r7, _r8, _r9,
                                                                                                        _rA);

        private static readonly GradientItemColors _itemToolItemPressedColors = new GradientItemColors(_rD, _rE, _rF,
                                                                                                       _rG, _rH, _rI,
                                                                                                       _rJ, _rK, _r9,
                                                                                                       _rA);

        private static readonly GradientItemColors _itemToolItemCheckedColors = new GradientItemColors(_rL, _rM, _rN,
                                                                                                       _rO, _rP, _rQ,
                                                                                                       _rR, _rS, _r9,
                                                                                                       _rA);

        private static readonly GradientItemColors _itemToolItemCheckPressColors = new GradientItemColors(_rT, _rU, _rV,
                                                                                                          _rW, _rX, _rI,
                                                                                                          _rY, _rZ, _r9,
                                                                                                          _rA);
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (button.Selected || button.Pressed || button.Checked)
                this.RenderToolButtonBackground(e.Graphics, button, e.ToolStrip);
        }
        ...
        protected override void OnRenderItemCheck(ToolStripItemImageRenderEventArgs e)
        {
            ...
            using (UseAntiAlias uaa = new UseAntiAlias(e.Graphics))
            {
                ...
                using (GraphicsPath borderPath = this.CreateBorderPath(checkBox, _cutMenuItemBack))
                {
                    // Fill the background in a solid color
                    using (SolidBrush fillBrush = new SolidBrush(this.ColorTable.CheckBackground))
                    ...
                    if (e.Image != null)
                    {
                        ...
                        switch (checkState)
                        {
                            case CheckState.Checked:
                                ...
                                using (GraphicsPath tickPath = this.CreateTickPath(checkBox))
                                {
                            ...
                            case CheckState.Indeterminate:
                                ...
                                using (GraphicsPath tickPath = this.CreateIndeterminatePath(checkBox))
                                {
                                    // Draw the tick with a thickish brush
        ...
        protected override void OnRenderSplitButtonBackground(ToolStripItemRenderEventArgs e)
        {
            if (e.Item.Selected || e.Item.Pressed)
            {
                ...
                this.RenderToolSplitButtonBackground(e.Graphics, splitButton, e.ToolStrip);
                ...
                this.OnRenderArrow(new ToolStripArrowRenderEventArgs(e.Graphics,
                                                                     splitButton,
                                                                     arrowBounds,
                              ...
                              lightBrush = new SolidBrush(_gripLight))
            {
                ...
                for (int i = _gripLines; i >= 1; i--)
                {
                    ...
                    for (int j = 0; j < i; j++)
                    {
                        ...
                        this.DrawGripGlyph(e.Graphics, x, y, darkBrush, lightBrush);
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                using (GraphicsPath borderPath = this.CreateBorderPath(e.AffectedBounds, _cutContextMenu),
                                    clipPath = this.CreateClipBorderPath(e.AffectedBounds, _cutContextMenu))
                {
        ...
        protected override void OnRenderImageMargin(ToolStripRenderEventArgs e)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                using (SolidBrush backBrush = new SolidBrush(this.ColorTable.ImageMarginGradientBegin))
        ...
        protected override void OnRenderToolStripBorder(ToolStripRenderEventArgs e)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                // Create border and clipping paths
                using (
                    GraphicsPath borderPath = this.CreateBorderPath(e.AffectedBounds, e.ConnectedArea, _cutContextMenu),
                                 insidePath = this.CreateInsideBorderPath(e.AffectedBounds, e.ConnectedArea,
                                                                          _cutContextMenu),
                                 clipPath = this.CreateClipBorderPath(e.AffectedBounds, e.ConnectedArea, _cutContextMenu)
                    )
                {
                    // Create the different pen colors we need
                    using (Pen borderPen = new Pen(this.ColorTable.MenuBorder),
        ...
        private void DrawContextMenuHeader(Graphics g, ToolStripItem item)
        {
            ...
            // Create border and clipping paths
            using (GraphicsPath borderPath = this.CreateBorderPath(itemRect, _cutToolItemMenu),
                                insidePath = this.CreateInsideBorderPath(itemRect, _cutToolItemMenu),
                                clipPath = this.CreateClipBorderPath(itemRect, _cutToolItemMenu))
            {
                // Clip all drawing to within the border path
