...
namespace Terminals.Forms.Controls
{
    public class SplitButton : Button
    {
        ...
        {
            private get { return this.m_SplitMenuStrip; }
            set
            {
        ...
        protected override void OnMouseUp(MouseEventArgs mevent)
        {
            ...
            if (mevent.Button == MouseButtons.Right && this.ClientRectangle.Contains(mevent.Location) &&
                !this.isSplitMenuVisible)
            {
                this.ShowContextMenuStrip();
            }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            this.PaintTextandImage(g,
                                   new Rectangle(0, 0, this.ClientRectangle.Width - SplitSectionWidth,
        ...
        private void PaintTextandImage(Graphics g, Rectangle bounds)
        {
            ...
            if (!string.IsNullOrEmpty(this.Text))
            {
                if (this.Enabled)
                    ...
                    ControlPaint.DrawStringDisabled(g, this.Text, this.Font, this.BackColor, text_rectangle,
        ...
        private void PaintArrow(Graphics g, Rectangle dropDownRect)
        {
            ...
            g.FillPolygon(this.Enabled ? SystemBrushes.ControlText : SystemBrushes.ButtonShadow, arrow);
        }
