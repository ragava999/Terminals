...
namespace CodeEditor
{
    ...
    internal sealed class IniLexer
    {
        ...
        public static void Init(Scintilla scintilla)
        {
        	...
        	{
        		Kohl.Framework.Logging.Log.Fatal("Unable to initialise the scintilla lexer.");
        	}
        }
        ...
        public void Style()
        {
            ...
            {
            	Kohl.Framework.Logging.Log.Fatal("Unable to set our user defined desired Scintilla style.");
            }
        }
