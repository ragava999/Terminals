...
namespace Kohl.Framework.WinForms
{
	public class PersistWindowState : Component
	{
		...
		private void OnClosing(object sender, CancelEventArgs e)
		{
			...
			{
				this.SaveStateEvent(this, registryKey);
			}
		}
		...
		private void OnLoad(object sender, EventArgs e)
		{
			...
			if (registryKey != null)
			{
				...
				{
					this.LoadStateEvent(this, registryKey);
				}
			}
		}
		...
		public event PersistWindowState.WindowStateDelegate LoadStateEvent;

		public event PersistWindowState.WindowStateDelegate SaveStateEvent;
