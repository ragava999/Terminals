...
namespace WalburySoftware
{
    public partial class TerminalEmulator : Control
    {
        ...
        private struct ParserEventArgs
        {
            ...
            public readonly uc_Params CurParams;
        ...
        {
            private readonly uc_CharEvents CharEvents = new uc_CharEvents();
            private readonly uc_Params CurParams = new uc_Params();
            private readonly uc_StateChangeEvents StateChangeEvents = new uc_StateChangeEvents();
            ...
            public void ParseString(String InString)
            {
                ...
                foreach (Char C in InString)
                {
                    ...
                    this.CharEvents.GetStateEventAction(this.State, this.CurChar, ref NextState, ref NextAction);
            ...
            private void DoAction(Actions NextAction)
            {
                ...
                switch (NextAction)
                {
                    ...
                    case Actions.Print:
                        ...
                        this.ParserEvent(this,
                                         new ParserEventArgs(NextAction, this.CurChar, this.CurSequence, this.CurParams));
                        break;
            ...
            {
                public static readonly uc_CharEventInfo[] Elements =
                    {
            ...
            {
                private readonly uc_StateChangeInfo[] Elements =
                    {
