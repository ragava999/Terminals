...
namespace WalburySoftware
{
    public partial class TerminalEmulator : Control
    {
        ...
        private class uc_CaretAttribs
        {
            ...
            public readonly uc_Chars.Sets G0Set;
            public readonly uc_Chars.Sets G1Set;
            public readonly uc_Chars.Sets G2Set;
            public readonly uc_Chars.Sets G3Set;
        ...
        private void Tab()
        {
            ...
            {
                if (i > this.Caret.Pos.X && this.TabStops.Columns[i])
                {
        ...
        private void ShowCaret(Graphics CurGraphics)
        {
            ...
            else if (this.AttribGrid[Y][X].UseAltBGColor)
            {
