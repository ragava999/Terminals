...
namespace WalburySoftware
{
    public partial class TerminalEmulator : Control
    {
        private class uc_Chars
        {
            ...
            public static readonly uc_CharSet[] DECSG =
                {
            ...
            public static readonly uc_CharSet[] DECS =
                {
            ...
            public static readonly uc_CharSet[] ASCII = // same as Basic Latin
                {
                    new uc_CharSet(0x00, 0x0000), //
                };

            public static readonly uc_CharSet[] NRCUK = // UK National Replacement
                {
                    new uc_CharSet(0x23, 0x00A3), //
                };

            public static readonly uc_CharSet[] NRCFinnish = // Finnish National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCFrench = // French National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCFrenchCanadian = // French Canadian National Replacement
                {
                    new uc_CharSet(0x40, 0x00E0), // a with grav accent
            ...
            public static readonly uc_CharSet[] NRCGerman = // German National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCItalian = // Italian National Replacement
                {
                    new uc_CharSet(0x23, 0x00A3), // pound sign
                    new uc_CharSet(0x40, 0x00A7), // funny s
                    new uc_CharSet(0x5B, 0x00B0), // Degree Symbol
            ...
            public static readonly uc_CharSet[] NRCNorDanish = // Norwegian Danish National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCPortuguese = // Portuguese National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCSpanish = // Spanish National Replacement
                {
                    new uc_CharSet(0x23, 0x00A3), // pound sign
                    new uc_CharSet(0x40, 0x00A7), // funny s
            ...
            public static readonly uc_CharSet[] NRCSwedish = // Swedish National Replacement
                {
            ...
            public static readonly uc_CharSet[] NRCSwiss = // Swiss National Replacement
                {
            ...
            public static readonly uc_CharSet[] ISOLatin1S = // Same as Latin-1 Supplemental
                {
                    new uc_CharSet(0x00, 0x0000) //
                };
