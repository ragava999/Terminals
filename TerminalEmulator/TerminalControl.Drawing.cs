...
namespace WalburySoftware
{
    public partial class TerminalEmulator : Control
    {
        ...
        private void ShowSpecialChar(Graphics CurGraphics, Char CurChar, Int32 Y, Int32 X, Color CurFGColor,
                                     Color CurBGColor)
        {
            if (CurChar == '\0')
            {
        ...
        private void ClearDown(Int32 Param)
        {
            ...
            switch (Param)
            {
                case 0: // from cursor to bottom inclusive
                    ...
                    this.ClearRowChars(caretRowIndex, caretCharIndex, charCount);
                    this.ClearRows(caretRowIndex + 1, this._rows);
                    break;

                case 1: // from top to cursor inclusive
                    this.ClearRowChars(caretRowIndex, 0, caretCharIndex + 1);
                    this.ClearRows(0, caretRowIndex);
                    break;

                case 2: // entire screen
                    this.ClearRows(0, this._rows);
                    break;
            }
        }
        ...
        {
            this.ClearRowChars(rowIndex, 0, this.CharGrid[rowIndex].Length);
        }
        ...
        private void ClearRight(Int32 Param)
        {
            ...
            switch (Param)
            {
                case 0: // from cursor to end of line inclusive
                    ...
                    this.ClearRowChars(caretRowIndex, caretCharIndex, charsCount);
                    break;
                ...
                case 2: // entire line
                    this.ClearRowChars(caretRowIndex, 0, this.CharGrid[caretRowIndex].Length);
                    break;
